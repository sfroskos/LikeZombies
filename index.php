...
//    $RedirectUrl = 'https://apps.facebook.com/likezombiesdev/index.php';
    ...
    if(isset($facebookLoginHtml)){ 
        ...
        echo "top.location.href='https://www.facebook.com/dialog/oauth?client_id={1432542257021113}&redirect_uri={https://likezombiesgame.com/}&scope=publish_actions,public_profile,user_friends,user_relationships,read_stream,publish_actions';"; 
        echo '</script>';        
    }
}
